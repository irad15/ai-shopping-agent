...
export default function ProductCard({
    ...
    return (
        <motion.div
            ...
            className="group relative w-full max-w-[280px] rounded-xl bg-zinc-900 border border-zinc-800 overflow-hidden shadow-lg hover:shadow-indigo-500/10 hover:border-zinc-700 transition-all duration-300"
        >
            {/* Image */}
